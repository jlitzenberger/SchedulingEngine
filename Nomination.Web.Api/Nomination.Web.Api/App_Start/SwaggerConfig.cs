...
using Nomination.Web.Api;
using Swashbuckle.Application;
using System.Net.Http;
using System.Collections.Generic;
using Swashbuckle.Swagger;
using System.Web.Http.Description;
using Nomination.Web.Api.Controllers;
...
namespace Nomination.Web.Api
{
	public class SwaggerConfig
	{
				...
				.EnableSwagger(c =>
					{
						...
						//
						c.SingleApiVersion("v1", "Nomination.Web.Api");
						...
						//c.IncludeXmlComments(string.Format(@"C:\Development\PEGAsys\SchedulingEngine\Nomination.Domain\bin\Debug\Nomination.Domain.XML"));
						c.IncludeXmlComments(string.Format(@"{0}\bin\Nomination.Domain.XML", System.AppDomain.CurrentDomain.BaseDirectory));
				...
				.EnableSwaggerUi(c =>
					{
						...
						c.InjectStylesheet(thisAssembly, "Nomination.Web.Api.CustomContent.theme-muted.css");
						...
						c.CustomAsset("index", thisAssembly, "Nomination.Web.Api.CustomContent.index.html");
		...
		{
			return string.Format(@"{0}\bin\Nomination.Web.Api.XML", System.AppDomain.CurrentDomain.BaseDirectory);
		}

		private static string GetRootUrlFromAppConfig(HttpRequestMessage request)
		{
			...
			var port = GetHeaderValue(request, "X-Forwarded-Port") ?? request.RequestUri.Port.ToString();
