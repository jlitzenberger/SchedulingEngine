...
namespace Nomination.Domain.ConfirmationResponse.Naesb
{
    [XmlRoot("ConfirmationResponse")]
    public class NaesbConfirmationResponse
    {
    ...
    public class Identifier
    {
        ...
        public string IdCodeQualifier { get; set; }
        public string Code { get; set; }
        //[XmlElement(ElementName = "IndentifierDetails")]
